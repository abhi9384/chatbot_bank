...
# Initialize the Ollama model locally using Langchain
...
def generate_response(user_input):
    ...
    Please use the given context to provide concise answers to the user's question.
    Don't try to make up an answer if it is not provided in the context.
    If the user asks questions about topics not related to Bank policies and procedures, just say "I'm sorry, I don't know the answer to that." 
    ...
    For questions related to Bank policies and procedures, respond in a maximum of 4-5 sentences.
    """
...
# Streamlit UI layout
st.set_page_config(page_title="Bank Local Ollama GenAI Chatbot", layout="wide")

# Custom title and description
st.markdown(""" 
    <h1 style='text-align: center; color: #4CAF50;'>Bank Local Ollama GenAI Chatbot</h1>
    <p style='text-align: center;'>Chat with an AI assistant powered by Ollama model. Ask questions, get creative, or have fun conversations!</p>
...
st.markdown(""" 
    <hr style="border:1px solid gray;">
    <p style="text-align: center; color: gray;">Powered by Ollama | Developed with Streamlit</p>
""", unsafe_allow_html=True)
